...
const contactData = [
    { icon: <FaGithub size={32} />, title: "GitHub", href: "https://github.com/manojaberathna24" },
    { icon: <FaLinkedin size={32} />, title: "LinkedIn", href: "https://www.linkedin.com/in/manojaberathna/" },
    { icon: <FiMail size={32} />, title: "Email", href: "mailto:sandaruwanctk@gmail.com" },
    { icon: <FiPhone size={32} />, title: "Phone", href: "tel:+94724240616" },
    { icon: <FaInstagram size={32} />, title: "Instagram", href: "https://www.instagram.com/YOUR_USERNAME" },
];
                    ...
                    <motion.form onSubmit={handleSubmit} variants={containerVariants} className="space-y-6">
                        ...
                        <div className="bg-[#112240] rounded-lg p-4 mb-6">
                            <div className="flex items-center gap-3 text-[#ccd6f6] mb-2">
                                ...
                                <span>sandaruwanctk@gmail.com</span>
                            </div>
                            <div className="flex items-center gap-3 text-[#ccd6f6] mb-2">
                                <FiPhone className="text-[#64ffda]" />
                                <span>+94 72 424 0616</span>
                            </div>
